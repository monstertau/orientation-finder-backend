      ...
      .bulkInsert("Categories", [
        {
          ...
          salary: `[ { "name": "VinAI", "position": "Data Scientist, Data Engineer" }, { "name": "Viettel", "position": "AI Engineer, Data Engineer" }, { "name": "Samsung R&D", "position": "AI Engineer, Data Engineer" }, { "name": "FPT Software", "position": "AI Engineer, Data Engineer" }, { "name": "IBM Viet Nam", "salary": "AI Engineer, Data Engineer" } ]`,
        ...
        },
        {
          ...
          intro:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
          salary: `[ { "name": "Shopee", "position": "Software Engineer,Backend Developer" }, { "name": "Viettel", "position": "Data Engineer, Backend Developer" }, { "name": "Samsung R&D", "position": "Software Engineer,Data Engineer" }, { "name": "FPT Software", "position": "Software Engineer, Devops" }, { "name": "Misa", "salary": "Devops,Backend Developer" } ]`,
        ...
        },
        {
          ...
          intro:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
          salary: `[ { "name": "Viettel", "position": "Network Security Engineer, Malware Engineer" }, { "name": "CMC", "position": "Network Security Engineer, System Security Engineer" }, { "name": "BKAV Group", "position": "Software Engineer,Data Engineer" }, { "name": "VNISA", "position": "Software Engineer, Devops" }, { "name": "VP Bank", "salary": "Security Analysis" } ]`,
        ...
        },
        {
          ...
          intro:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
          salary: `[ { "name": "VNG", "position": "Game Developer,Game Designer" }, { "name": "GearInc", "position": "Game Developer,Game Designer" }, { "name": "Gameloft", "position": "Game Developer,Game Designer" }, { "name": "Garena", "position": "Game Developer,Game Designer" }, { "name": "VTC", "salary": "Game Developer,Game Designer" } ]`,
